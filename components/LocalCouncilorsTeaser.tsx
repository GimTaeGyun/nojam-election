...
import { getOverall, computeRegionStats } from "@/lib/localCouncilorStats";
import { formatKrw } from "@/lib/parseNum";

export function LocalCouncilorsTeaser() {
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="text-[11px] font-mono text-neon/80 mb-1">기초의회</div>
              <h2 className="text-2xl sm:text-3xl font-black tracking-tightest leading-tight">
                구·시·군의원 <span className="text-neon">{overall.total.toLocaleString()}명</span>
              </h2>
