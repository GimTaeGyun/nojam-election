...
export function PartyStatsTeaser() {
  ...
  return (
    <section className="py-12 border-t border-paper/10">
      ...
      >
        <div className="text-[11px] font-mono text-neon/80 mb-2">신박한 한 페이지</div>
        <h2 className="text-2xl sm:text-3xl font-black tracking-tightest">
          정당별 출마자{" "}
          <span className="text-neon">전과 신고 현황</span>
        </h2>
        <p className="text-sm text-paper/60 mt-2 leading-relaxed">
          시·도지사 후보 {overall.total}명 중 {overall.hasCrim}명이 전과 신고.
        ...
        <div className="text-xs text-neon mt-5 font-semibold">
          전체 보기 →
        </div>
      </Link>
    </section>
